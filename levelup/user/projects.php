...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post" onsubmit="return projectverification()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="project-type" aria-describedby="emailHelp"
                                placeholder="Website, Android app etc." name="projtype">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="30" rows="4" class="form-control" id="project-descript"
                                placeholder="Give some info about your Project" name="projdesc"></textarea>
                        </div>
                        <div class="form-group">
    ...
    <div class="main-containt">
        <div class="container">
            ...
            <?php
            // $userid = $_SESSION['user_id'];
            $fatchprojectsql = "SELECT * FROM `project` WHERE userid = '$userid'";
            $result = mysqli_query($conn, $fatchprojectsql);
            ?>
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row2['projectname']; ?></td>
                        <td><?php echo $row2['projecttype']; ?></td>
                        <td><?php echo $row2['projectcompleteyear']."/ ". $row2['projectcompletemonth']; ?></td>
                        <td>
                        <?php
                        if ($row2['projecturl']) {
                            echo '<a href="' . $row2['projecturl'] . '" class="btn btn-primary btn-background-colour" target="_blank">View</a>';
                        } else {
                            echo '<button disabled="disabled" class="btn btn-dange">Not-avaliable</button>';
                        }
                         ?>
                        </td>
                        <td><a href="userphpfiles/editproject.php?edit_project_id=<?php echo $row2['sno']; ?>"><i
                                    class="fas fa-edit text-success"></a></td>
                        <td><a href="userphpfiles/projectdelete.php?delete_project_id=<?php echo $row2['sno']; ?>"><i
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $projectinsertsql = "INSERT INTO `project`(`projectname`, `projecttype`, `projectcompleteyear`, `projectcompletemonth`, `projectdiscp`, `projecturl`, `userid`) VALUES ('$projectname','$projecttype','$projectyear','$projectmonth','$projectdesc','$projecturl','$userid')";
    $result2 = mysqli_query($conn, $projectinsertsql);

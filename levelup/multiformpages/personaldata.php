...
$personaldatasql = "SELECT * FROM `userpersonaldetails` WHERE sno = $userid";
$resultque = mysqli_query($conn, $personaldatasql);
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="phone" class="form-control" id="phone" placeholder="9999-9999-99 *" maxlength="10"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="email" class="form-control" id="email" placeholder="username@example.com *"
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="location" class="form-control" id="location" placeholder="Noida, Utter Pradesh *"
...
<div class="form-group">
    ...
    <textarea name="objective" id="" cols="30" rows="10" class="form-control" id="intro"
        placeholder="Write about yourself (min 200 characters) *" ><?php echo $row['objective']; ?></textarea>
</div>